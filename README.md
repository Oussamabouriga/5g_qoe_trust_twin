...
The final Random Forest produced **8,365 false positives** on the sealed test
set, corresponding to a **7.96% false-alarm rate**.

Trust results:

- validation-selected abstention threshold: **0.6711849773025693**;
- validation coverage: **90.20%**;
- accepted predictions: **162,116**;
- abstained predictions: **17,212**;
- test coverage: **90.40%**;
- test abstention rate: **9.60%**;
- accepted-decision accuracy: **0.9340 (93.40%)**;
