...
def save_confusion_matrix(
    ...
    matrix_frame.to_csv(
        TABLE_DIRECTORY
        / "prototype_confusion_matrix.csv"
    )
    ...
    figure.savefig(
        FIGURE_DIRECTORY
        / "prototype_confusion_matrix.pdf",
        bbox_inches="tight",
    )
...
def save_precision_recall_curve(
    ...
    figure.savefig(
        FIGURE_DIRECTORY
        / "prototype_precision_recall_curve.png",
        dpi=300,
        bbox_inches="tight",
    )
    ...
    figure.savefig(
        FIGURE_DIRECTORY
        / "prototype_precision_recall_curve.pdf",
        bbox_inches="tight",
    )
...
def save_reliability_diagram(
    ...
    figure.savefig(
        FIGURE_DIRECTORY
        / "prototype_reliability_diagram.png",
        dpi=300,
        bbox_inches="tight",
    )
    ...
    figure.savefig(
        FIGURE_DIRECTORY
        / "prototype_reliability_diagram.pdf",
        bbox_inches="tight",
    )
...
def save_trust_distribution(
    ...
    figure.savefig(
        FIGURE_DIRECTORY
        / "prototype_trust_distribution.png",
        dpi=300,
        bbox_inches="tight",
    )
    ...
    figure.savefig(
        FIGURE_DIRECTORY
        / "prototype_trust_distribution.pdf",
        bbox_inches="tight",
    )
...
def save_accuracy_by_trust(
    ...
    figure.savefig(
        FIGURE_DIRECTORY
        / "prototype_accuracy_by_trust.png",
        dpi=300,
        bbox_inches="tight",
    )
    ...
    figure.savefig(
        FIGURE_DIRECTORY
        / "prototype_accuracy_by_trust.pdf",
        bbox_inches="tight",
    )
...
def save_lead_time_histogram(
    ...
    figure.savefig(
        FIGURE_DIRECTORY
        / "prototype_lead_time_histogram.png",
        dpi=300,
        bbox_inches="tight",
    )
    ...
    figure.savefig(
        FIGURE_DIRECTORY
        / "prototype_lead_time_histogram.pdf",
        bbox_inches="tight",
    )
...
def save_feature_importance() -> pd.DataFrame:
    ...
    importance.to_csv(
        TABLE_DIRECTORY
        / "prototype_feature_importance.csv",
        index=False,
    )
    ...
    figure.savefig(
        FIGURE_DIRECTORY
        / "prototype_feature_importance.png",
        dpi=300,
        bbox_inches="tight",
    )
    ...
    figure.savefig(
        FIGURE_DIRECTORY
        / "prototype_feature_importance.pdf",
        bbox_inches="tight",
    )
...
def main() -> None:
    ...
    overall_frame.to_csv(
        TABLE_DIRECTORY
        / "prototype_final_metrics.csv",
        index=False,
    )

    trust_metrics.to_csv(
        TABLE_DIRECTORY
        / "prototype_trust_metrics.csv",
        index=False,
    )

    base_station_metrics.to_csv(
        TABLE_DIRECTORY
        / "prototype_metrics_by_base_station.csv",
        index=False,
    )

    prb_metrics.to_csv(
        TABLE_DIRECTORY
        / "prototype_metrics_by_prb.csv",
        index=False,
    )

    bitrate_metrics.to_csv(
        TABLE_DIRECTORY
        / "prototype_metrics_by_bitrate.csv",
        index=False,
    )

    reliability.to_csv(
        TABLE_DIRECTORY
        / "prototype_final_reliability_table.csv",
        index=False,
    )
    ...
    pd.DataFrame(
        ...
        TABLE_DIRECTORY
        / "prototype_lead_time_statistics.csv",
        index=False,
    )
    ...
    summary_path = (
        METRIC_DIRECTORY
        / "prototype_final_evaluation.json"
    )
